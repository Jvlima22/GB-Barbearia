...
const ItemDetailsDialog = ({
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-[90vw] overflow-hidden border-white/10 bg-[#1A1A1A] p-0 text-white sm:max-w-[450px] [&>button]:top-6 [&>button]:right-6">
                {/* IMAGEM EM DESTAQUE */}
                <div className="relative h-[250px] w-full">
                    ...
                    <Badge
                        className="absolute left-5 top-5 bg-[#3EABFD] text-white hover:bg-[#3EABFD]"
                    >
                ...
                <div className="flex flex-col gap-4 p-6 pt-0">
                    <DialogHeader>
                        ...
                        <DialogDescription className="sr-only">Detalhes sobre o item {item.name}</DialogDescription>
                    </DialogHeader>

                    <div className="flex flex-col gap-2">
                        <div className="flex items-center gap-2 text-[#3EABFD]">
                            <InfoIcon size={16} />
                            <span className="text-sm font-semibold uppercase tracking-wider">Descrição</span>
                        </div>
